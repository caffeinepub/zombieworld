...
export class Backend implements backendInterface {
    ...
    async getActivePlayers(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getActivePlayers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBestScore(): Promise<HighScore> {
        if (this.processError) {
            try {
    ...
    async getGlobalLeaderboard(arg0: bigint): Promise<Array<HighScore>> {
        if (this.processError) {
            try {
    ...
    async recordActivePlayer(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.recordActivePlayer();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordPlayerLeave(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.recordPlayerLeave();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
